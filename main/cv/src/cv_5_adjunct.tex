...
\address{1202 Nye St. Unit B, San Rafael, CA, 94901} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{(713)~$\cdot$~471~$\cdot$~9513 \\ sakha002@ucr.edu \\ sakha002.github.io} % Your phone number and email
...
Power system analysis: & \begin{tabular}{l}  Power/energy systems operation and planning, electricity market operations.   \end{tabular} \\
\vspace{0.16cm}

Smart \& Sustainable grid: & \begin{tabular}{l}   Distribution grid modeling, Distributed Energy Resources. \end{tabular} \\ \vspace{0.16cm}
...
Programming: & \begin{tabular}{l}  Python, Go, MATLAB  \end{tabular} \\
\vspace{0.16cm}

Development Tools/Tech: & \begin{tabular}{l} Docker, gRPC, graphQL, KubeFlow, AirFlow    \end{tabular} \\
\vspace{0.16cm}
Optimization Software: & \begin{tabular}{l} CPLEX, GUROBI, Pyomo, ORtools   \end{tabular} \\ \vspace{0.16cm}
...
Miscellaneous: &\begin{tabular}{l}  Linux,  GitOps (Gitlab, CICD, etc.) \end{tabular} \\ 
